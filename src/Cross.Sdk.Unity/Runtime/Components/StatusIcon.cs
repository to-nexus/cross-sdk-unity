...
namespace Cross.Sdk.Unity.Components
{
    public class StatusIcon : VisualElement
    {
        ...
        public const string SuccessIconPath = "Cross/Sdk/Icons/icon_medium_checkmark";
        ...
        {
            var asset = Resources.Load<VisualTreeAsset>("Cross/Sdk/Components/StatusIcon/StatusIcon");
