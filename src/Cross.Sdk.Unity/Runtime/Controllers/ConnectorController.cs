...
namespace Cross.Sdk.Unity
{
    public class ConnectorController : Connector
    {
        ...
        protected override async Task InitializeAsyncCore(CrossSdkConfig config, SignClientUnity signClient)
        {
        ...
        protected override void ConnectionConnectedHandler(ConnectionProposal connectionProposal)
        {
            ...
            CrossSdk.NotificationController.Notify(NotificationType.Success, "Connected!");
