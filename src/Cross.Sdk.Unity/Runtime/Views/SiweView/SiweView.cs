...
using Button = Cross.Sdk.Unity.Components.Button;

namespace Cross.Sdk.Unity.Views.SiweView
{
    public class SiweView : VisualElement
    {
        ...
        {
            var asset = Resources.Load<VisualTreeAsset>(visualTreePath ?? "Cross/Sdk/Views/SiweView/SiweView");
