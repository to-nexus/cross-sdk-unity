...
namespace Cross.Sdk.Unity.Components
{
    public class WalletSearchView : VisualElement
    {
        ...
        {
            var asset = Resources.Load<VisualTreeAsset>(visualTreePath ?? "Cross/Sdk/Views/WalletSearchView/WalletSearchView");
            ...
            {
                vectorImage = Resources.Load<VectorImage>("Cross/Sdk/Icons/icon_medium_magnifier")
            });
            ...
            if (deviceType is DeviceType.Phone)
                qrCodeLink.image.vectorImage = Resources.Load<VectorImage>("Cross/Sdk/Icons/icon_regular_qrcode");
            else
