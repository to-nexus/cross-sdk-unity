...
namespace Cross.Sdk.Unity
{
    public class ModalHeaderPresenter : Presenter<ModalHeader>
    {
        ...
        public ModalHeaderPresenter(RouterController routerController, Modal parent) : base(routerController, parent)
        {
            ...
            CrossSdk.NotificationController.Notification += NotificationHandler;
            CrossSdk.ModalController.OpenStateChanged += ModalOpenStateChangedHandler;
            ...
            var goBackIconLink = new IconLink(
                Resources.Load<VectorImage>("Cross/Sdk/Icons/icon_medium_chevronleft"),
            ...
            View.rightSlot.Add(new IconLink(
                Resources.Load<VectorImage>("Cross/Sdk/Icons/icon_bold_xmark"),
                CrossSdk.CloseModal
            ));
        }
        ...
        private IEnumerator ShowSnackbarCoroutine(NotificationEventArgs notification)
        {
            ...
            {
                NotificationType.Error => Resources.Load<VectorImage>("Cross/Sdk/Icons/icon_bold_warningcircle"),
                NotificationType.Success => Resources.Load<VectorImage>("Cross/Sdk/Icons/icon_bold_checkmark"),
                NotificationType.Info => Resources.Load<VectorImage>("Cross/Sdk/Icons/icon_bold_info"),
                _ => Resources.Load<VectorImage>("Cross/Sdk/Icons/icon_bold_warningcircle")
            };
