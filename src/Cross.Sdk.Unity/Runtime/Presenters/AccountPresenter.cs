    ...
    public class AccountPresenter : Presenter<AccountView>
    {
        ...
        private void AccountPropertyChangedHandler(object sender, PropertyChangedEventArgs e)
        {
            switch (e.PropertyName)
            {
                ...
                case nameof(AccountController.Balance):
                    View.SetBalance(TrimToThreeDecimalPlaces(CrossSdk.AccountController.Balance));
                    break;
                case nameof(AccountController.BalanceSymbol):
                    View.SetBalanceSymbol(CrossSdk.AccountController.BalanceSymbol);
                    break;
            }
        }
        ...
        protected virtual void CreateNetworkButton(VisualElement buttonsListView)
        {
            _networkButton = new ListItem("Network", OnNetworkButtonClick, null, ListItem.IconType.Circle)
            {
                IconFallbackElement =
                {
                    vectorImage = Resources.Load<VectorImage>("Cross/Sdk/Icons/icon_medium_info")
                }
            };
        ...
        {
            var disconnectIcon = Resources.Load<VectorImage>("Cross/Sdk/Icons/icon_medium_disconnect");
        ...
        {
            var profileName = CrossSdk.AccountController.ProfileName;
        ...
        {
            var avatar = CrossSdk.AccountController.ProfileAvatar;

            if (avatar.IsEmpty || avatar.AvatarFormat != "png" && avatar.AvatarFormat != "jpg" && avatar.AvatarFormat != "jpeg")
            {
                var address = CrossSdk.AccountController.Address;
        ...
        {
            base.OnVisibleCore();
            UpdateNetworkButton(CrossSdk.NetworkController.ActiveChain);
        }
        ...
        {
            var chain = CrossSdk.NetworkController.ActiveChain;
        ...
        protected virtual void OnCopyAddressButtonClick()
        {
            ...
            CrossSdk.NotificationController.Notify(NotificationType.Success, "Ethereum address copied");
        }
