...
namespace Cross.Core.Crypto.Interfaces
{
    /// <summary>
    ...
    public interface IKeyChain : IModule
    {
        ...
        /// <summary>
        ///     Get a saved key with the given tag. If no tag exists, then a CrossNetworkException will
        ///     be thrown.
        /// </summary>
        /// <param name="tag">The tag of the key to retrieve</param>
        /// <returns>The key with the given tag</returns>
        /// <exception cref="CrossNetworkException">Thrown if the given tag does not match any key</exception>
        Task<string> Get(string tag);

        /// <summary>
        ///     Delete a key with the given tag. If no tag exists, then a CrossNetworkException will
        ///     be thrown.
        /// </summary>
