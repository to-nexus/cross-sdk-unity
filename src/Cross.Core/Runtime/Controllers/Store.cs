...
namespace Cross.Core.Controllers
{
    ...
    public class Store<TKey, TValue> : IStore<TKey, TValue> where TValue : IKeyHolder<TKey>
    {
        ...
        public Store(ICoreClient coreClient, string name, string storagePrefix = null)
        {
            ...
            StoragePrefix = storagePrefix ?? Cross.Core.CoreClient.StoragePrefix;
        }
        ...
        /// <exception cref="CrossNetworkException">Thrown when the given key doesn't exist in this Store</exception>
